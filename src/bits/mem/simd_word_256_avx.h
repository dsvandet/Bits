...
#ifndef _BITS_MEM_SIMD_WORD_256_AVX_H
#define _BITS_MEM_SIMD_WORD_256_AVX_H
...
struct bitword<256> {
    ...
    inline uint16_t popcount() const {
        return bits::popcnt64(u64[0]) + bits::popcnt64(u64[1]) + bits::popcnt64(u64[2]) +
               (uint16_t)bits::popcnt64(u64[3]);
    }
