...
#ifndef _BITS_MEM_SIMD_BIT_TABLE_H
#define _BITS_MEM_SIMD_BIT_TABLE_H
...
struct simd_bit_table {
    ...
    /// Creates a square table with 1's down the off diagonal
    static simd_bit_table lambda(size_t n);
...
#include "bits/mem/simd_bit_table.inl"
